<template>
  <v-row justify="center" align="center">
    ...
    <v-col cols="12" class="text-center ma-0 pa-0">
      <v-img
        width="100%"
        class="d-flex align-center mb-10 text-align-left"
        eager
        ...
        <v-row justify="center" align="center">
          <v-col class="col-5">
            <v-img
              height="100%"
              width="100%"
              :src="require('../static/ibs-white.png')"
            ></v-img>
          </v-col>
          <v-col class="col-9">
            <!-- <h1 class="text-md-h1 text-h2 mt-5 text-center">
              INNOVATIVE BRICK SYSTEMS
            </h1> -->
            <h2 class="text-md-h3 text-sm-h4 text-h5 mt-5 text-center">
              - INDUSTRY LEADER IN CUSTOM THIN-BRICK DESIGN -
            </h2>
          </v-col>
          <v-col class="col-8 d-flex justify-center">
            <p class="text-md-h5 text-h6 mt-5 text-center">
      ...
      >
        <v-col class="col-12 col-md-7">
          ...
          >
            ...
            >
            <v-card-text
              class="text-md-h5 text-sm-h6 text-body-1 mt-md-5 text-justify"
            >
