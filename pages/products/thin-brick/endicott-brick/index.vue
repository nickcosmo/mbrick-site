<template>
  <v-row>
    ...
    <v-row class="pa-0 ma-0 col-12 align-center justify-center">
      <v-col class="col-10 ma-0 pa-0 d-flex flex-wrap justify-center">
        <v-card
          class="pa-0 ma-5"
        ...
        >
          <div class="text-wrap" style="width: 100%">
            ...
            >
              <v-card-subtitle
                class="text-subtitle-2 text-center justify-center pa-2"
  ...
  async asyncData(context) {
    const products = await context.app.$storyapi
      .get("cdn/stories", {
        ...
        starts_with: "products/thin_brick/endicott_brick",
      })
      .then((res) => {
